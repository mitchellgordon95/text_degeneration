...
3. **The long tail of logprobs is unreliable** - Generating low-probability tokens via pure sampling lead to incoherent generation
  - *Perplexity Gap*: Underconfidence ratio (GPT-2: 8.4x)
